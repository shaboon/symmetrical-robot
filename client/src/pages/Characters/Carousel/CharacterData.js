// import { QUERY_CHARACTERS } from "../../../components/utils/queries";

// export const SliderData = await QUERY_CHARACTERS();
...
export const SliderData = [
  ...
  },
  {
    ...
    born: -24,
    formerAffiliations: [],
    appearances: ["Star Wars: Episode IV - A New Hope"],
  },
  {
    id: 10,
    name: "Obi-Wan Kenobi",
  ...
  },
  {
    ...
    born: -37,
    formerAffiliations: [],
    appearances: ["Star Wars: Episode V - The Empire Strikes Back"],
  },
  {
    id: 27,
    name: "Ackbar",
  ...
  },
  {
    ...
    eyeColor: "brown",
    skinColor: "light",
    affiliations: ["Alliance to Restore the Republic", "Green Squadron"],
    hairColor: "brown",
    formerAffiliations: [],
  ...
  },
  {
    ...
    affiliations: ["Bright Tree tribe", "Alliance to Restore the Republic"],
    skinColor: "brown",
    born: -8,
    formerAffiliations: [],
    appearances: [
  ...
  },
  {
    ...
    affiliations: ["Gungan Grand Army"],
    formerAffiliations: [],
    appearances: [
      "Star Wars: Episode I - The Phantom Menace",
      "Star Wars: The Clone Wars",
  ...
  },
  {
    ...
    eyeColor: "yellow",
    skinColor: "green",
    affiliations: ["Gungan High Council"],
    formerAffiliations: [],
    appearances: [
      "Star Wars: Episode I - The Phantom Menace",
      "Star Wars: Episode III - Revenge of the Sith",
  ...
  },
  {
    ...
    skinColor: "fair",
    formerAffiliations: [],
    appearances: ["Star Wars: Episode I - The Phantom Menace"],
  },
  {
    id: 40,
    name: "Watto",
    ...
    eyeColor: "orange",
    skinColor: "blue",
    affiliations: ["Watto's shop", "Mos Espa"],
    hairColor: "black",
    formerAffiliations: [],
    appearances: [
      "Star Wars: Episode I - The Phantom Menace",
  ...
  },
  {
    ...
    eyeColor: "brown",
    skinColor: "light",
    affiliations: ["Skywalker family", "Lars family"],
    formerAffiliations: [],
    appearances: [
      "Star Wars: Episode I - The Phantom Menace",
      "Star Wars: Episode II - Attack of the Clones",
  ...
  },
  {
    ...
    eyeColor: "pink",
    skinColor: "light",
    affiliations: ["Fortuna family", "Jabba Desilijic Tiure's criminal empire"],
    formerAffiliations: [],
    appearances: [
      "Star Wars: Episode VI - Return of the Jedi",
      "Star Wars: Episode I - The Phantom Menace",
  ...
  },
  {
    ...
    affiliations: ["Jedi Order", "Jedi High Council", "Galactic Republic"],
    formerAffiliations: [],
    appearances: ["Star Wars: Episode I - The Phantom Menace"],
  },
  {
  ...
  },
  {
    ...
    born: -82,
    formerAffiliations: [],
    appearances: ["Star Wars: Episode II - Attack of the Clones"],
  },
  {
    id: 63,
  ...
  },
  {
    ...
    masters: ["Yoda (Jedi)", "Darth Sidious (Sith)"],
    apprentices: [
      "Qui-Gon Jinn (Jedi)",
  ...
  },
  {
    ...
    eyeColor: "brown",
    skinColor: "tan",
    era: ["Rise of the Empire era", "Rebellion era"],
    affiliations: [
      "House of Organa",
  ...
  },
  {
    ...
    eyeColor: "brown",
    skinColor: "tan",
    affiliations: ["Confederacy of Independent Systems", "Tyranus"],
    born: -66,
    formerAffiliations: [],
    appearances: ["Star Wars: Episode II - Attack of the Clones"],
  },
  {
    ...
    species: "clawdite",
    skinColor: "green",
    affiliations: ["Mabari", "Confederacy of Independent Systems"],
    hairColor: "blond",
    eyeColor: "yellow",
    formerAffiliations: [],
    appearances: ["Star Wars: Episode II - Attack of the Clones"],
  ...
  },
  {
    ...
    eyeColor: "blue",
    skinColor: "light",
    affiliations: ["Jedi Order", "Jedi High Council"],
    formerAffiliations: [],
    appearances: [
      "Star Wars: Episode II - Attack of the Clones",
      "Star Wars: The Clone Wars",
  ...
  },
  {
    ...
    eyeColor: "brown",
    skinColor: "dark",
    affiliations: ["First Order", "FN Corps", "Resistance"],
    formerAffiliations: [],
    appearances: [
      "Star Wars: Episode VII - The Force Awakens",
      "Star Wars: Forces of Destiny",
  ...
  },
  {
    ...
    gender: "male",
    homeworld: "aq vetina",
    wiki: "https://starwars.fandom.com/wiki/Din_Djarin",
    image:
      "https://en.wikipedia.org/wiki/The_Mandalorian_%28character%29#/media/File:TheMandalorian.jpg",
    species: "yoda's species",
    hairColor: "white",
    eyeColor: "brown",
    skinColor: "tan",
  ...
  },
  {
    ...
    height: 0.34,
    gender: "male",
    wiki: "https://starwars.fandom.com/wiki/Din_Grogu",
    image:
      "https://static.wikia.nocookie.net/starwars/images/4/43/TheChild-Fathead.png",
    species: "yoda's species",
    hairColor: "white",
    eyeColor: "brown",
    skinColor: "green",
  ...
  },
  {
    ...
    species: "yoda's species",
    eyeColor: "blue",
    skinColor: "orange (with white markings and blue stripes)",
    affiliations: [
      "Jedi Order",
      "Galactic Republic",
  ...
  },
  {
    ...
    image:
      "https://static.wikia.nocookie.net/starwars/images/f/fd/K-2SO_Sideshow.png",
    dateCreated: -12,
    dateDestroyed: 0,
    destroyedLocation: "scarif",
    ...
    sensorColor: "white",
    platingColor: "black",
    affiliations: ["Galactic Empire", "Alliance to Restore the Republic"],
    formerAffiliations: [],
    appearances: ["Rogue One: A Star Wars Story", "Andor"],
  },
  {
    id: 94,
    name: "Jyn Erso",
  ...
  },
  {
    ...
    eyeColor: "brown, yellow (dark side)",
    skinColor: "light",
    affiliations: [
      "Solo family",
      "Skywalker family",
    ...
    masters: ["Luke Skywalker", "Darth Sidious"],
    formerAffiliations: [],
    appearances: [
      "Star Wars: Episode VII - The Force Awakens",
      "Star Wars: Episode VIII - The Last Jedi",
  ...
  },
  {
    ...
    eyeColor: "red",
    skinColor: "blue",
    cybernetics: "removable breathing tubes, metal headplate",
    affiliations: [
      "Cad Bane's group",
      "Sith",
      "Hutt Clan",
  ...
  },
  {
    ...
    height: 1.63,
    gender: "female",
    wiki: "https://starwars.fandom.com/wiki/Fennec_Shand",
    image:
      "https://static.wikia.nocookie.net/starwars/images/b/b4/FennecShandHS-TMCh15.png",
    species: "human",
    hairColor: "black",
    eyeColor: "brown",
    skinColor: "tan",
    cybernetics: "Abdomen",
    affiliations: ["Hutt Clan", "Fett gotra"],
    formerAffiliations: [],
    appearances: ["The Mandalorian", "The Bad Batch", "The Book of Boba Fett"],
  },
  {
    id: 99,
    name: "IG-11",
    ...
    image:
      "https://static.wikia.nocookie.net/starwars/images/2/2c/MarshalIG-11.jpg",
    manufacturer: "Halowan Mechanicals",
    model: "IG-series assassin droid",
    class: "Assassin droid, Nurse droid, Police droid",
    sensorColor: "red",
    platingColor: "gray and bronze",
    affiliations: ["Bounty Hunters' Guild", "New Republic"],
    formerAffiliations: [],
  ...
  },
  {
    ...
    diedLocation: "jedha",
    species: "human",
    hairColor: "black, with orange stripe; later graying, no orange stripe",
    eyeColor: "blue, later green, later brown",
    skinColor: "dark",
    cybernetics:
      "Cybernetic right arm, oxygen respirator, pressurized suit of armor, reinforced lungs",
    affiliations: [
      "Onderon rebels",
      "Galactic Republic",
      "Royal Court of Onderon",
      "Royal Onderon Miltia",
      "Partisans",
      "Alliance to Restore the Republic",
    ],
    apprentices: ["Jyn Erso", "Reece Tallent"],
    formerAffiliations: [],
    appearances: [
      "Star Wars: The Clone Wars",
      "Star Wars: Rebels",
